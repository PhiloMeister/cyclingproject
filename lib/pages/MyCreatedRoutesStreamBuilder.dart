...
class MyCreatedRoutesStreamBuilder extends StatefulWidget {
  const MyCreatedRoutesStreamBuilder({super.key});

  @override
  State<MyCreatedRoutesStreamBuilder> createState() => _MyCreatedRoutesStreamBuilderState();
}
class _MyCreatedRoutesStreamBuilderState extends State<MyCreatedRoutesStreamBuilder> {
  var checkTextField = "";
